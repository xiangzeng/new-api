...
type TaskBillingContext struct {
	...
	ResellerCustomerId        int                `json:"reseller_customer_id,omitempty"`
	ResellerCustomerBindingId int64              `json:"reseller_customer_binding_id,omitempty"`
	ResellerMultiplierBps     int                `json:"reseller_multiplier_bps,omitempty"`
	ResellerMultiplierSource  string             `json:"reseller_multiplier_source,omitempty"`
	BaseGroupRatio            float64            `json:"base_group_ratio,omitempty"`
	RetailGroupRatio          float64            `json:"retail_group_ratio,omitempty"`
	BasePreConsumedQuota      int                `json:"base_pre_consumed_quota,omitempty"`
	RetailPreConsumedQuota    int                `json:"retail_pre_consumed_quota,omitempty"`
}
